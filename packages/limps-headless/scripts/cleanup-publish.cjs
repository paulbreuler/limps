 ...
 * 
 * Note: For limps-headless, we do NOT delete LICENSE because it's a real file
...
// No cleanup needed for limps-headless since LICENSE is a real file in the repo
