---
title: limps-headless Providers
---

# Providers

Providers allow limps-headless to support different component libraries. Each provider implements a common interface and registers itself with the provider registry.
...
```typescript
import { registerProvider } from '@sudosandwich/limps-headless/providers';
