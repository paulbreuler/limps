...
export default function TagsRemoveCommand({ args, options }: Props): React.ReactNode {
  ...
  const help = buildHelpOutput({
    usage: 'limps docs tags remove <path> [options]',
    ...
    examples: [
      ...
      'limps docs tags remove plans/0001-feature/000-agent.md --tags urgent high-priority',
      'limps docs tags remove plans/0001-feature/000-agent.md --tags urgent --json',
    ],
  });
